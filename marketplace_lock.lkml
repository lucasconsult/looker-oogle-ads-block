...
marketplace_ref: {
  ...
  override_constant: CONNECTION_NAME { value:"connection" }
  override_constant: GOOGLE_ADS_SCHEMA { value:"schema" }
  override_constant: GOOGLE_ADS_CUSTOMER_ID { value:"12345" }
}
